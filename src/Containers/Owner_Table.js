    ...
    let data = {
      ...
      subject:
        n == 3
          ...
          : `${name} has rejected your request.`,
      message:
        n == 3
          ? `${name} has accepted your request. Please check your account.`
          : `${name} has rejected your request. Please check your account.`,
    }
                        ...
                        <TableCell key={column.id} align={column.align}>
                          ...
                          value == 'GovtApproved' ? (
                            <Button
                              variant="contained"
                              color="primary"
                              onClick={() => this.handleMakeAvailable(row['property'])}
                            >
                              Make Available
                            </Button>
                          ) : column.id == 'isAvailable' &&
